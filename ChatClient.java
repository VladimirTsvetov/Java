...
import ru.gb.gbchat1.readwritehistory.HistoryHolder;
...
public class ChatClient {
    ...
    private HistoryHolder historyHolder = null;
    ...
    public void openConnection() throws IOException {
        ...
        Thread trWaitAuth = new Thread(()->{
            try {
                ...
                historyHolder.writeHistory("history_" + nick + ".txt",true); //файл будет записан полюбому
                closeConnection();
            }
        });
            ...
            try {
                ...
                if(msg.startsWith("/authok")){
                    ...
                    controller.addMessage("Успешная авторизация под ником " + nick +
                            historyHolder.readHistory("history_" + nick + ".txt"));
